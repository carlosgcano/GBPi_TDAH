...
class Points_Utils(object):
	...
	def get_trophies_and_medals_from_points():
		...
		trophies_value = Points_Utils.get_trophy_value_from_server()
		medals_value = Points_Utils.get_medal_value_from_server()
		
		total_points = Points_Utils.get_points()

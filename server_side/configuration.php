        ...
        <div class="content">
            ...
            <div class="pure-g">
                <form action="form/form_submit.php" class="alt" method="POST">
                    ...
                    <div class="n_subj">
                    <input name="n_subj" placeholder="Asignaturas" type="number">
                    </div>                    
                    <div class="n_act">
                    <input name="n_act" placeholder="Actitudes" type="number">
                    </div>
                    <div class="n_medal">
                    <input name="n_medal" placeholder="Medallas" type="number">
                    </div>
                    <div class="n_trophy">
                    <input name="n_trophy" placeholder="Trofeos" type="number">
                    </div>                    
                    </div>
                    <br/>
